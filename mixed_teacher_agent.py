...
class MixedTeacherAgent(BaseAgent):
    ...
    def reset(self):
        ...
        - random_prob = (uniform(0, 1))^2
        - heuristic_temperature = (uniform(0, 1))^2
        """
        # Sample per-episode parameters
        self.random_prob = np.random.uniform(0, 1) ** 2
        self.heuristic_temperature = np.random.uniform(0, 1) ** 2
